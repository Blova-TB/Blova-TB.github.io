const buildPortfolioData = () => ({
  ...
  items: [
    ...
    {
      titre: "Structure of an MMO",
      categorie: "Project",
      tags: ["Docker", "Sharding : Quad-tree", "Rust", "atomization of services", "Networking", "Bevy"],
      description: "A project to understand the structure of an MMO. It includes a spacial server, a broker, clients, gatekeeper, game server, and AOI server.",
    ...
    },
    {
      ...
      description: "A 3D platformer speedrun prototype with a unique particle-based movement system. The player collects particles to gain abilities and successfully navigate through the levels.",
