const buildPortfolioData = () => ({
  ...
  items: [
    ...
    {
      titre: "Structure d'un MMO",
      categorie: "Projet",
      tags: ["Docker", "Sharding : Quad-tree", "Rust", "atomization of services", "Networking", "Bevy"],
      description: "Un projet pour comprendre la structure d'un MMO. il contient un spacial server, un broker, clients, gatekeeper, game server, and AOI server.",
      lien: "https://github.com/Blova-TB/UQAC_T3_MMO",
      image: "img/MMOpp.png",
      colorClass: "border-emerald-400/40 bg-emerald-500/15 text-emerald-200",
      color: "from-emerald-500/40 to-teal-500/40",
    },
    {
      titre: "Particule Remanence",
      categorie: "Projet",
      tags: ["Unreal Engine", "C++", "3D platformer", "Physics Rework", "Niagara"],
      description: "Un platformer 3D type speedrun avec un système de mouvement unique basé sur des particules. Le joueur collecte des particules pour acquérir des capacités et naviguer avec succès à travers les niveaux.",
      lien: "https://alexandre-h.itch.io/particle-remanence",
      image: "img/ParticuleRemanence.png",
      colorClass: "border-emerald-400/40 bg-emerald-500/15 text-emerald-200",
      color: "from-emerald-500/40 to-teal-500/40",
    },
    {
